...
class ExpensesService:
    ...
    def create(self, user_id: int, data: ExpenseDTO) -> List[Expense]:
        ...
        for i in range(data.total_installment):
            expense = Expense(
                user_id=user_id,
                value=data.value /data.total_installment,
            ...
            expenses.append(self.repository.create(expense))
